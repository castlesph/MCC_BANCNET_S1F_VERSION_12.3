...
{     
	...
	vdDebug_LogPrintf("saturn inCCTRead");
...
int inDatabase_BatchRead(TRANS_DATA_TABLE *transData, int inSeekCnt)
{
	...
	char *sql = "SELECT MITid, HDTid, CDTid, IITid, byTransType, byPanLen, szExpireDate, byEntryMode, szTotalAmount, szBaseAmount, szTipAmount, byOrgTransType, szMacBlock, szYear, szDate, szTime, szOrgDate, szOrgTime, szAuthCode, szRRN, szInvoiceNo, szOrgInvoiceNo, byPrintType, byVoided, byAdjusted, byUploaded, byTCuploaded, szCardholderName, szzAMEX4DBC, szStoreID, szRespCode, szServiceCode, byContinueTrans, byOffline, byReversal, byEMVFallBack, shTransResult, szTpdu, szIsoField03, szMassageType, szPAN, szCardLable, usTrack1Len, usTrack2Len, usTrack3Len, szTrack1Data, szTrack2Data, szTrack3Data, usChipDataLen, baChipData, usAdditionalDataLen, baAdditionalData, bWaveSID,usWaveSTransResult,bWaveSCVMAnalysis,ulTraceNum, ulOrgTraceNum, usTerminalCommunicationMode, ulSavedIndex, byPINEntryCapability, byPackType, szOrgAmount, szCVV2, inCardType, byTCFailUpCnt, byCardTypeNum, byEMVTransStatus, T5A_len, T5A, T5F2A, T5F30, T5F34, T5F34_len, T82, T84_len, T84, T8A, T91, T91Len, T95, T9A, T9C, T9F02, T9F03, T9F09, T9F10_len, T9F10, T9F1A, T9F26, T9F27, T9F33, T9F34, T9F35, T9F36_len, T9F36, T9F37, T9F41, T9F53, ISR, ISRLen, T9B, T5F24, T71Len, T71, T72Len, T72, T9F06, T9F1E, T9F28, T9F29, szChipLabel, szTID, szMID, szHostLabel, szBatchNo, szTerms, szFactorRate, szMoAmort, szTotalInstAmnt, szPromo, szInstallmentData, fInstallment, szProductCode, szCustomerNo, szLoyaltyData, fLoyalty, szBancnetBatchNo, szBancnetTraceNo, szBank_Mnemonic, inAccountType, szECRMessage1, szECRMessage2, szECRMessage3, szECRMessage4, szTranYear, szServiceFee FROM TransData WHERE ulSavedIndex = ?";
	/* open the database */
	result = sqlite3_open(DB_BATCH,&db);
	if (result != SQLITE_OK) {
		sqlite3_close(db);
...
int inDatabase_BatchInsert(TRANS_DATA_TABLE *transData)
{
	...
	char *sql1 = "SELECT MAX(TransDataid) FROM TransData";
 	...
 	char *sql = "INSERT INTO TransData (TransDataid, HDTid, MITid, CDTid, IITid, szHostLabel, szBatchNo, byTransType, byPanLen, szExpireDate, byEntryMode, szTotalAmount, szBaseAmount, szTipAmount, byOrgTransType, szMacBlock, szYear, szDate, szTime, szOrgDate, szOrgTime, szAuthCode, szRRN, szInvoiceNo, szOrgInvoiceNo, byPrintType, byVoided, byAdjusted, byUploaded, byTCuploaded, szCardholderName, szzAMEX4DBC, szStoreID, szRespCode, szServiceCode, byContinueTrans, byOffline, byReversal, byEMVFallBack, shTransResult, szTpdu, szIsoField03, szMassageType, szPAN, szCardLable, usTrack1Len, usTrack2Len, usTrack3Len, szTrack1Data, szTrack2Data, szTrack3Data, usChipDataLen, baChipData, usAdditionalDataLen, baAdditionalData, bWaveSID,usWaveSTransResult,bWaveSCVMAnalysis, ulTraceNum, ulOrgTraceNum, usTerminalCommunicationMode, ulSavedIndex, byPINEntryCapability, byPackType, szOrgAmount, szCVV2, inCardType, byTCFailUpCnt, byCardTypeNum, byEMVTransStatus, T5A_len, T5A, T5F2A, T5F30, T5F34, T5F34_len, T82, T84_len, T84, T8A, T91, T91Len, T95, T9A, T9C, T9F02, T9F03, T9F09, T9F10_len, T9F10, T9F1A, T9F26, T9F27, T9F33, T9F34, T9F35, T9F36_len, T9F36, T9F37, T9F41, T9F53, ISR, ISRLen, T9B, T5F24, T71Len, T71, T72Len, T72, T9F06, T9F1E, T9F28, T9F29, szChipLabel, szTID, szMID, szHostLabel, szBatchNo, szTerms, szFactorRate, szMoAmort, szTotalInstAmnt, szPromo, szInstallmentData, fInstallment, szProductCode, szCustomerNo, szLoyaltyData, fLoyalty, szBancnetBatchNo, szBancnetTraceNo, szBank_Mnemonic, inAccountType, szECRMessage1, szECRMessage2, szECRMessage3, szECRMessage4, szTranYear, szServiceFee) VALUES (NULL, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	/* open the database */
	result = sqlite3_open(DB_BATCH,&db);
	if (result != SQLITE_OK) {
		sqlite3_close(db);
...
int inDatabase_BatchSearch(TRANS_DATA_TABLE *transData, char *hexInvoiceNo)
{
	int result,i = 0;
	int inResult = d_NO;
	char *sql = "SELECT HDTid, MITid, CDTid, IITid, byTransType, byPanLen, szExpireDate, byEntryMode, szTotalAmount, szBaseAmount, szTipAmount, byOrgTransType, szMacBlock, szYear, szDate, szTime, szOrgDate, szOrgTime, szAuthCode, szRRN, szInvoiceNo, szOrgInvoiceNo, byPrintType, byVoided, byAdjusted, byUploaded, byTCuploaded, szCardholderName, szzAMEX4DBC, szStoreID, szRespCode, szServiceCode, byContinueTrans, byOffline, byReversal, byEMVFallBack, shTransResult, szTpdu, szIsoField03, szMassageType, szPAN, szCardLable, usTrack1Len, usTrack2Len, usTrack3Len, szTrack1Data, szTrack2Data, szTrack3Data, usChipDataLen, baChipData, usAdditionalDataLen, baAdditionalData, bWaveSID,usWaveSTransResult,bWaveSCVMAnalysis,ulTraceNum, ulOrgTraceNum, usTerminalCommunicationMode, ulSavedIndex, byPINEntryCapability, byPackType, szOrgAmount, szCVV2, inCardType, byTCFailUpCnt, byCardTypeNum, byEMVTransStatus, T5A_len, T5A, T5F2A, T5F30, T5F34, T5F34_len, T82, T84_len, T84, T8A, T91, T91Len, T95, T9A, T9C, T9F02, T9F03, T9F09, T9F10_len, T9F10, T9F1A, T9F26, T9F27, T9F33, T9F34, T9F35, T9F36_len, T9F36, T9F37, T9F41, T9F53, ISR, ISRLen, T9B, T5F24, T71Len, T71, T72Len, T72, T9F06, T9F1E, T9F28, T9F29, szChipLabel, szTID, szMID, szHostLabel, szBatchNo, szTerms, szFactorRate, szMoAmort, szTotalInstAmnt, szPromo, szInstallmentData, fInstallment, szProductCode, szCustomerNo, szLoyaltyData, fLoyalty, szBancnetBatchNo, szBancnetTraceNo, inAccountType, szECRMessage1, szECRMessage2, szECRMessage3, szECRMessage4, szTranYear, szServiceFee FROM TransData WHERE szInvoiceNo = ?";
...
int inDatabase_BatchReadByTransId(TRANS_DATA_TABLE *transData, int inTransDataid)
{
	int result;
	int inResult = d_NO;
	char *sql = "SELECT MITid, HDTid, CDTid, IITid, byTransType, byPanLen, szExpireDate, byEntryMode, szTotalAmount, szBaseAmount, szTipAmount, byOrgTransType, szMacBlock, szYear, szDate, szTime, szOrgDate, szOrgTime, szAuthCode, szRRN, szInvoiceNo, szOrgInvoiceNo, byPrintType, byVoided, byAdjusted, byUploaded, byTCuploaded, szCardholderName, szzAMEX4DBC, szStoreID, szRespCode, szServiceCode, byContinueTrans, byOffline, byReversal, byEMVFallBack, shTransResult, szTpdu, szIsoField03, szMassageType, szPAN, szCardLable, usTrack1Len, usTrack2Len, usTrack3Len, szTrack1Data, szTrack2Data, szTrack3Data, usChipDataLen, baChipData, usAdditionalDataLen, baAdditionalData, bWaveSID,usWaveSTransResult,bWaveSCVMAnalysis, ulTraceNum, ulOrgTraceNum, usTerminalCommunicationMode, ulSavedIndex, byPINEntryCapability, byPackType, szOrgAmount, szCVV2, inCardType, byTCFailUpCnt, byCardTypeNum, byEMVTransStatus, T5A_len, T5A, T5F2A, T5F30, T5F34, T5F34_len, T82, T84_len, T84, T8A, T91, T91Len, T95, T9A, T9C, T9F02, T9F03, T9F09, T9F10_len, T9F10, T9F1A, T9F26, T9F27, T9F33, T9F34, T9F35, T9F36_len, T9F36, T9F37, T9F41, T9F53, ISR, ISRLen, T9B, T5F24, T71Len, T71, T72Len, T72, T9F06, T9F1E, T9F28, T9F29, szChipLabel, szTID, szMID, szHostLabel, szBatchNo, szTerms, szFactorRate, szMoAmort, szTotalInstAmnt, szPromo, szInstallmentData, fInstallment, szProductCode, szCustomerNo, szLoyaltyData, fLoyalty, szTranYear, szServiceFee, inAccountType FROM TransData WHERE TransDataid = ?";
...
int inSSLRead(int inSeekCnt)
{
	int result;
	int inResult = d_NO;
	char *sql = "SELECT inAmexETHDirect, szAMEXRTIND, szAMEXORIGIN, szAMEXCOUNTRY, szAMEXMESSAGE, szAMEXREGION, szAMEXCONTENT_TYPE, szAMEXHOST, szAMEXCACHE_CONTROL, szAMEXCONNECTION, szDummy1, szDummy2, szDummy3 FROM SSL WHERE SSLid = ?";
		
	/* open the database */
	result = sqlite3_open(DB_POST,&db);
	if (result != SQLITE_OK) {
		sqlite3_close(db);
		return 1;
	}
	...
	do {
		...
		if (result == SQLITE_ROW) { /* can read data */
			...
			/* inAmexETHDirect */
			strSSL.inAmexETHDirect = sqlite3_column_int(stmt,inStmtSeq);	
			/* szAMEXRTIND */			
			strcpy((char*)strSSL.szAMEXRTIND, (char *)sqlite3_column_text(stmt,inStmtSeq +=1 ));
			/*szAMEXORIGIN*/
			strcpy((char*)strSSL.szAMEXORIGIN, (char *)sqlite3_column_text(stmt,inStmtSeq +=1 ));
			/*szAMEXCOUNTRY*/
			strcpy((char*)strSSL.szAMEXCOUNTRY, (char *)sqlite3_column_text(stmt,inStmtSeq +=1 ));
			/*szAMEXMESSAGE*/
			strcpy((char*)strSSL.szAMEXMESSAGE, (char *)sqlite3_column_text(stmt,inStmtSeq +=1 ));
			/*szAMEXREGION*/
			strcpy((char*)strSSL.szAMEXREGION, (char *)sqlite3_column_text(stmt,inStmtSeq +=1 ));
			/*szAMEXCONTENT_TYPE*/
			strcpy((char*)strSSL.szAMEXCONTENT_TYPE, (char *)sqlite3_column_text(stmt,inStmtSeq +=1 ));
			/*szAMEXHOST*/
			strcpy((char*)strSSL.szAMEXHOST, (char *)sqlite3_column_text(stmt,inStmtSeq +=1 ));
			/*szAMEXCACHE_CONTROL*/
			strcpy((char*)strSSL.szAMEXCACHE_CONTROL, (char *)sqlite3_column_text(stmt,inStmtSeq +=1 ));
			/*szAMEXCONNECTION*/
			strcpy((char*)strSSL.szAMEXCONNECTION, (char *)sqlite3_column_text(stmt,inStmtSeq +=1 ));
			/*szDummy1*/
			strcpy((char*)strSSL.szDummy1, (char *)sqlite3_column_text(stmt,inStmtSeq +=1 ));
			/*szDummy2*/
			strcpy((char*)strSSL.szDummy2, (char *)sqlite3_column_text(stmt,inStmtSeq +=1 ));
			/*szDummy3*/
			strcpy((char*)strSSL.szDummy3, (char *)sqlite3_column_text(stmt,inStmtSeq +=1 ));
...
{
	int result;
	char *sql = "UPDATE SSL SET inAmexETHDirect = ?, szAMEXRTIND = ?, szAMEXORIGIN = ?, szAMEXCOUNTRY = ?, szAMEXMESSAGE = ?, szAMEXREGION = ?, szAMEXCONTENT_TYPE = ?, szAMEXHOST = ?, szAMEXCACHE_CONTROL = ?, szAMEXCONNECTION = ?, szDummy1 = ?, szDummy2 = ?, szDummy3 = ? WHERE  SSLid = ?";
	...
	inStmtSeq = 0;
	/* inAmexETHDirect */
	result = sqlite3_bind_int(stmt, inStmtSeq +=1, strSSL.inAmexETHDirect);
	/* szAMEXRTIND */
	result = sqlite3_bind_text(stmt, inStmtSeq +=1, (char*)strSSL.szAMEXRTIND, strlen((char*)strSSL.szAMEXRTIND), SQLITE_STATIC);
	/* szAMEXORIGIN */
	result = sqlite3_bind_text(stmt, inStmtSeq +=1, (char*)strSSL.szAMEXORIGIN, strlen((char*)strSSL.szAMEXORIGIN), SQLITE_STATIC);
	/* szAMEXCOUNTRY */
	result = sqlite3_bind_text(stmt, inStmtSeq +=1, (char*)strSSL.szAMEXCOUNTRY, strlen((char*)strSSL.szAMEXCOUNTRY), SQLITE_STATIC);
	/* szAMEXMESSAGE */
	result = sqlite3_bind_text(stmt, inStmtSeq +=1, (char*)strSSL.szAMEXMESSAGE, strlen((char*)strSSL.szAMEXMESSAGE), SQLITE_STATIC);
	/* szAMEXREGION */
	result = sqlite3_bind_text(stmt, inStmtSeq +=1, (char*)strSSL.szAMEXREGION, strlen((char*)strSSL.szAMEXREGION), SQLITE_STATIC);
	/* szAMEXCONTENT_TYPE */
	result = sqlite3_bind_text(stmt, inStmtSeq +=1, (char*)strSSL.szAMEXCONTENT_TYPE, strlen((char*)strSSL.szAMEXCONTENT_TYPE), SQLITE_STATIC);
	/* szAMEXHOST */
	result = sqlite3_bind_text(stmt, inStmtSeq +=1, (char*)strSSL.szAMEXHOST, strlen((char*)strSSL.szAMEXHOST), SQLITE_STATIC);
	/* szAMEXCACHE_CONTROL */
	result = sqlite3_bind_text(stmt, inStmtSeq +=1, (char*)strSSL.szAMEXCACHE_CONTROL, strlen((char*)strSSL.szAMEXCACHE_CONTROL), SQLITE_STATIC);
	/* szAMEXCONNECTION */
	result = sqlite3_bind_text(stmt, inStmtSeq +=1, (char*)strSSL.szAMEXCONNECTION, strlen((char*)strSSL.szAMEXCONNECTION), SQLITE_STATIC);
	/* szDummy1 */
	result = sqlite3_bind_text(stmt, inStmtSeq +=1, (char*)strSSL.szDummy1, strlen((char*)strSSL.szDummy1), SQLITE_STATIC);
	/* szDummy2 */
	result = sqlite3_bind_text(stmt, inStmtSeq +=1, (char*)strSSL.szDummy2, strlen((char*)strSSL.szDummy2), SQLITE_STATIC);
	/* szDummy3 */
	result = sqlite3_bind_text(stmt, inStmtSeq +=1, (char*)strSSL.szDummy3, strlen((char*)strSSL.szDummy3), SQLITE_STATIC);
...
int inSSL_Update(int inCommMode)
{
	int result;
    //char *sql = "UPDATE CPT SET inCommunicationMode = ?, inIPHeader = ?";
    char *sql = "UPDATE SSL SET inAmexETHDirect = ?";
