...
int inCTOS_CheckInitComm(int inCommType)
{
    ...
    vdDebug_LogPrintf("inCTOS_CheckInitComm.end");
...
int inGPRS_ConnectHost(TRANS_DATA_TABLE *srTransPara)
{
	...
	inBDOSMVal = get_env_int("BDOSM");

	vdDebug_LogPrintf("::inGPRS_ConnectHost::inBDOSMVal[%d]", inBDOSMVal);
...
int inModem_ConnectHost(TRANS_DATA_TABLE *srTransPara)
{
	...
	vdDebug_LogPrintf("::inModem_ConnectHost::inBDOSMVal[%d]", inBDOSMVal);
...
int inEthernet_ConnectHost(TRANS_DATA_TABLE *srTransPara)
{
	...
	vdDebug_LogPrintf("::inEthernet_ConnectHost::inBDOSMVal[%d]", inBDOSMVal);
