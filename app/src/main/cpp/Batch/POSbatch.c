...
int inCTOS_SaveBatchTxn(void)
{
    ...
    if((srTransRec.byTransType == SALE) || (srTransRec.byTransType == CASH_OUT) || (srTransRec.byTransType == REFUND) || (srTransRec.byTransType == SALE_OFFLINE) || (srTransRec.byTransType == PRE_AUTH)
