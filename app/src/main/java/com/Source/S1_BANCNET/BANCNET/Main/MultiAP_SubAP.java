...
//        int inTimes = FileCopyTime();
        ...
        this.mWakeLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK, "S1_BANCNET:AAA-MultiAP_SubAP>>WAKE_LOCK");
        ...
        {
            // copy file or Dir
            Log.d("inCTOSS_SubAPMain", "BANCNET START");
            copyFileOrDir("");
            Log.d("inCTOSS_SubAPMain", "BANCNET END");
            SharedPreferences.Editor editor = wmbPreference.edit();
            editor.putBoolean("FIRSTRUN", false);
            editor.commit();
           // Log.d("BANCNET IF isFirstRun", "BANCNET run inCTOSS_ProcessCfgExpress START");
            //inCTOSS_ProcessCfgExpress();
           // Log.d("BANCNET IF isFirstRun", "BANCNET run inCTOSS_ProcessCfgExpress END");
        }else{
            Log.d("BANCNET", "ELSE isFirstRun");
           // inCTOSS_ProcessCfgExpress();
           // Log.d("BANCNET ELSE isFirstRun", "BANCNET run inCTOSS_ProcessCfgExpress END");
