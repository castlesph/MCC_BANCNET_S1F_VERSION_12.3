...
public class S1InputString extends DemoAppActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mWakeLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK, "S1_BANCNET:S1InputString>>WAKE_LOCK");
        this.mWakeLock.acquire();

        Intent intent=getIntent();
        String value=intent.getStringExtra("pass_in_string");
        Log.i("saturn value", value);
