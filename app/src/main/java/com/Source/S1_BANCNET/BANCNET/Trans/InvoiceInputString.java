...
public class InvoiceInputString extends DemoAppActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mWakeLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK, "S1_BANCNET:AAA-InvoiceInputString>>WAKE_LOCK");
    ...
    public void FuncKeyCancel(){
        ...
        public void onClick(View v) {
            ...
            final_string = "CANCEL";
            startActivity(new Intent(InvoiceInputString.this,MainActivity.class));
            InvoiceInputString.this.finish();
