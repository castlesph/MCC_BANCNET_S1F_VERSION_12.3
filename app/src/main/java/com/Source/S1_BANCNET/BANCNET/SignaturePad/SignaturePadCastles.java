package com.Source.S1_BANCNET.BANCNET.SignaturePad;
...
public class SignaturePadCastles extends DemoAppActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mWakeLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK, "S1_BANCNET:AAA-SignaturePadCastles>>WAKE_LOCK");
        ...
        mSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                convertor.convertBitmap(resizeBmp, "/data/data/com.Source.S1_BANCNET.BANCNET/signtest.bmp");
